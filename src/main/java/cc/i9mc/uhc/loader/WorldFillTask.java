...
public class WorldFillTask implements Runnable {
    private static volatile DecimalFormat decimalFormat = new DecimalFormat("0.0");
    ...
    private Util.Callback callback;
    ...
    public WorldFillTask(Server theServer, String worldName, int radius, int chunksPerRun, Util.Callback callback) {
    ...
    private void sendMessage(String text) {
        ...
        LoggerUtil.info(text + " (memory available: " + availMem + " MB)");
    ...
    public String getFormattedPercentageCompleted() {
        ...
        return decimalFormat.format(perc) + "%";
    }
